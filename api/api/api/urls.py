...
from users.views import login, signup, change_password, many_users, single_user, metric_data, many_fridge, single_fridge, many_shopping_list, single_shopping_list, many_saved_recipes, single_saved_recipe
...
urlpatterns = [
    ...
    path('homemade/many_recipes/<uuid:user_pk>', many_recipes),
    ...
    path('homemade/change_password', change_password),
